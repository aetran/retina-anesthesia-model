...
load([folder_results method_denoise '_' method_nonlinear '.mat']);
...
for cellnum = selected_cells
    [psth_cntrl, ~, rho_cntrl] = calc_psth(folder, allspk_bycell, cellnum, trial_cntrl, binsize, T);    
    [psth_washout, ~, rho_washout] = calc_psth(folder, allspk_bycell, cellnum, trial_washout, binsize, T);    
